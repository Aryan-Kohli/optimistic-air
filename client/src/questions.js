const question = [
    {
        ...
        QuestionHindi:"आप हाल ही में कैसा महसूस कर रहे हैं ? ",
        // okayish sad lonely irritated low suffocating empty darkness
    ...
    {
        id:5,
        QuestionHindi:"क्या आपके मन में मृत्यु या आत्महत्या के विचार आए हैं?",
        Question:"Have you had thoughts of death or suicide ?"
        
    },
    {
        id:6,
        QuestionHindi:"तुम्हें नींद कैसी आ रही है? क्या आपको सोने में कोई परेशानी होती है?",
        Question:"How is you sleep ? Are you have any trouble in sleeping ? "
    },
    {
        id:7,
        QuestionHindi:"आखिरी बार आपने अपने दोस्तों/परिवार/सहकर्मियों को अपनी भावनाओं के बारे में कब बताया था?",
        Question:"When was the last time you shared about your feelings to your friends/family/ Colleagues ?"
    }
];
